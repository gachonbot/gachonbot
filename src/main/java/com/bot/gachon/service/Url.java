...
public class Url {
    ...
    public static final String GUIDE_URL_NEWS="http://m.gachon.ac.kr/gachon/notice.jsp?boardType_seq=359";
    public static final String GUIDE_URL_EVENT="http://m.gachon.ac.kr/gachon/notice.jsp?boardType_seq=360";
